...
Service({
  "getMyProfile": Func([], [Opt(Donor)], ["query"]),
  "registerDonor": Func(
    [DonorInput],
    [Variant({ "ok": Null, "err": Text })],
    []
  ),
  "searchDonors": Func([BloodGroup$1], [Vec(Donor)], ["query"]),
  "updateDonor": Func(
    [DonorInput],
    [Variant({ "ok": Null, "err": Text })],
    []
...
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const BloodGroup2 = IDL2.Variant({
    "ANeg": IDL2.Null,
    "APos": IDL2.Null,
    "BNeg": IDL2.Null,
    "BPos": IDL2.Null,
  ...
  return IDL2.Service({
    "getMyProfile": IDL2.Func([], [IDL2.Opt(Donor2)], ["query"]),
    "registerDonor": IDL2.Func(
      [DonorInput2],
      [IDL2.Variant({ "ok": IDL2.Null, "err": IDL2.Text })],
      []
    ),
    "searchDonors": IDL2.Func([BloodGroup2], [IDL2.Vec(Donor2)], ["query"]),
    "updateDonor": IDL2.Func(
      [DonorInput2],
      [IDL2.Variant({ "ok": IDL2.Null, "err": IDL2.Text })],
      []
    )
...
var BloodGroup = /* @__PURE__ */ ((BloodGroup2) => {
  BloodGroup2["ANeg"] = "ANeg";
  BloodGroup2["APos"] = "APos";
  BloodGroup2["BNeg"] = "BNeg";
  BloodGroup2["BPos"] = "BPos";
  BloodGroup2["ONeg"] = "ONeg";
  BloodGroup2["OPos"] = "OPos";
  BloodGroup2["ABNeg"] = "ABNeg";
  BloodGroup2["ABPos"] = "ABPos";
  return BloodGroup2;
})(BloodGroup || {});
class Backend {
...
function from_candid_BloodGroup_n4(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n5(_uploadFile, _downloadFile, value);
}
function from_candid_Donor_n2(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n5(_uploadFile, _downloadFile, value) {
  return "ANeg" in value ? "ANeg" : "APos" in value ? "APos" : "BNeg" in value ? "BNeg" : "BPos" in value ? "BPos" : "ONeg" in value ? "ONeg" : "OPos" in value ? "OPos" : "ABNeg" in value ? "ABNeg" : "ABPos" in value ? "ABPos" : value;
}
...
function to_candid_BloodGroup_n8(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n9(_uploadFile, _downloadFile, value);
}
function to_candid_DonorInput_n6(_uploadFile, _downloadFile, value) {
...
export {
  BloodGroup as B,
  BLOOD_GROUP_OPTIONS as a,
  createActor as c,
  formatBloodGroup as f,
  motion as m
};
